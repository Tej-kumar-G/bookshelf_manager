...
@router.post("", response_model=BookstoreResponse, status_code=201)
...
@router.get("", response_model=List[BookstoreResponse])
...
@router.get("/{bookstore_id}", response_model=BookstoreResponse)
...
@router.put("/{bookstore_id}", response_model=BookstoreResponse)
...
@router.delete("/{bookstore_id}", status_code=204)
...
@router.post("/{bookstore_id}/books/{book_id}", response_model=BookstoreResponse)
...
@router.delete("/{bookstore_id}/books/{book_id}", response_model=BookstoreResponse)
...
@router.get("/base/{bookstore_id}", response_model=BaseBookstoreResponse)
